...
MERCURY_SIZE = 48
mercurySprite = pygame.transform.scale(mercurySprite, (MERCURY_SIZE, MERCURY_SIZE))
MINIMAP_SIZE = 150
MINIMAP_POS = (20, 20)
...
def draw_minimap():
    ...
    pygame.draw.circle(minimap, (0, 120, 255), (player_minimap_x, player_minimap_y), 5)  # Увеличили точку игрока
    for mercury_x, mercury_y in mercury_positions:
        ...
        pygame.draw.circle(minimap, (255, 0, 0), (mercury_minimap_x, mercury_minimap_y), 4)  # Увеличили точки Меркурия
